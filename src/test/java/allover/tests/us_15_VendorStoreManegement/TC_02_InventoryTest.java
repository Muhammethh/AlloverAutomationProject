...
public class TC_02_InventoryTest {
    ...
    public void displayMenuTest() throws InterruptedException {
        ...
        ExtentReportsListener.extentTestInfo("Inventory button a tiklanir.");
        ...
        ExtentReportsListener.extentTestInfo("ManageStockCheckBox button a tiklanir.");

        ActionsUtils.pressTab();
        storeManagerPage.StockQtyTextBox.sendKeys("2");
        ExtentReportsListener.extentTestInfo("Stock qty kismina '2' yazilir.");

        ActionsUtils.pressTab();
        storeManagerPage.AllowBackorders.click();
        ExtentReportsListener.extentTestInfo("Allow backorders button a tiklanir.");

        ReusableMethods.ddmValue(storeManagerPage.AllowBackorders,"notify");
        ExtentReportsListener.extentTestInfo("Allow backorders dropdown menusunde 'notify' secilir.");

        ReusableMethods.click(storeManagerPage.SoldIndividually);
        ExtentReportsListener.extentTestInfo("Sold individually button a tiklanir.");
