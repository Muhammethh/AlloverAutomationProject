...
public class TC_07 {
    ...
    public void testVendorInvalidEMailRegistration() throws InterruptedException {
        ...
        ExtentReportsListener.extentTestInfo("Gecerli e mail adresi girilir");
        ...
        String validVerification = "542147";
        vendorRegistrationPage.VerificationCodeInput.sendKeys(validVerification);
        ExtentReportsListener.extentTestInfo("verification code kismina gecerli code girilir");
        ...
        Assert.assertTrue(vendorRegistrationPage.SuccessRegistration.isDisplayed(),"Kayit islemi basarili");
        ExtentReportsListener.extentTestInfo("Kayit islemi basarili");
