...
public class TC_04 {
    ...
    public void testVendorInvalidEMailRegistration() throws InterruptedException {
        ...
        ExtentReportsListener.extentTestInfo("siteye zaten kayitli olan mail adresi girilir");
        ...
        Assert.assertTrue(vendorRegistrationPage.WarningEmailUsing.isDisplayed(),"Kayitli email adresi kullanilamaz");
        ExtentReportsListener.extentTestInfo("Kayitli email adresi kullanilamaz");
